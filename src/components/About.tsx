          ...
          <Card>
            <CardContent className="p-6">
              ...
              <p className="text-gray-700 text-justify">
                ...
                JNTUK from the Academic Year 2017-18. Since its inception in 1989, Sir C.R.Reddy College of Engineering has 
                been a premier institute for quality engineering education in Andhra Pradesh under the stewardship of its broad 
                minded and magnanimous management.
              </p>
              
              <p className="text-gray-700 mt-4 text-justify">
                The last two and a half decades has seen the Institute fulfilling its motto of "QUALITY SERVICE & VALUE 
                BASED EDUCATION" to the student community. Adhering to its core values, the institute gives top priority to 
                ethical values and high standards and a commitment to value based education.
              </p>
